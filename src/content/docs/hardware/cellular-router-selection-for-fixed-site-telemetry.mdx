...
description: Choose industrial cellular routers for fixed telemetry sites without overbuying speed, underbuying survivability, or ignoring data-plan and truck-roll cost.
...
contentCluster: field-hardware-design
canonicalCluster: field-hardware-design
pageType: hardware-guide
lifecycle: evergreen
